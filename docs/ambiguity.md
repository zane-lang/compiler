...
Menhir reports 68 states with shift/reduce conflicts and 2 with reduce/reduce
conflicts; the explanations file accounts for 70 conflict blocks, since a state
...
states and both reduce/reduce conflicts — 23 of the 70 — trace to a single
